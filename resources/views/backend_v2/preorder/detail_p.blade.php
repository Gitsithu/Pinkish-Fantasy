...
<div class="col-md-12" style="margin-top:40px!important;padding-right:100px!important;">
    ...
    <div class="row" id="row-margin-control" style="width:100%!important;margin-bottom:50px!important;">
        ...
        <div class="col-md-4">
            <form action="/admin/preorder/change_2/{{ $parameter }}" method="post" >
                <!-- <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> -->
      {{csrf_field()}}
      {{ method_field('PATCH') }}
                   <button type="submit"  class="form-control btn btn-info" style="font-weight:bold;padding-top:10px;height:40px;" id="btn_new">Make Receive Orders</button>
                      </form>
        </div>
        <div class="col-md-4">
        </div>
