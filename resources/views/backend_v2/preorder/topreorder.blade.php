                                    ...
                                    <tbody>
                                       ...
                                       <td class="text-center"><b>{{ $preorder->order_id}}</b></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/admin/preorder/detail_t/{{ $parameter }}" style="font-weight:bold;padding-top:10px;height:40px;background-color:#f5a8ae!important;border:#f5a8ae!important;" class="form-control btn btn-warning"  id="btn_new">View Detail</a>
...
$('a').click(function(){
    ...
    var d = typeof(data);
                    ...
                    $("#frm_pre").attr('action',"/admin/preorder/change");
