                                    ...
                                    <tbody>
                                       ...
                                       @foreach ($preorders as $preorder)
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/admin/preorder/detail_c/{{ $parameter }}" style="font-weight:bold;padding-top:10px;height:40px;background-color:#f5a8ae!important;border:#f5a8ae!important;" class="form-control btn btn-warning"  id="btn_new">View Detail</a>
