                       ...
                       @if (count($errors) > 0)
                            ...
                            <div class="col-md-3">
                                <a href="/admin/preorder" style="font-weight:bold;padding-top:10px;height:40px;" class="form-control btn btn-danger"  id="btn_new">To Preorder</a>
                                 ...
                                 <div class="col-md-3">
                 <a href="/admin/preorder/receive" style="font-weight:bold;padding-top:10px;height:40px;" class="form-control btn btn-info"  id="btn_new">Receive Orders</a>
                 </div>
                                    ...
                                    <tbody>
                                       ...
                                       @foreach ($preorders as $preorder)
                                        <tr>
                                            ...
                                            <td class="text-center"><img src="{{ $preorder->payment_screenshot}}" class="img-fluid rounded-circle" onclick="getImage(this.src)" style="width:50px; height:50px;" /></td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/admin/preorder/detail_p/{{ $parameter }}" style="font-weight:bold;padding-top:10px;height:40px;background-color:#f5a8ae!important;border:#f5a8ae!important;" class="form-control btn btn-warning"  id="btn_new">View Detail</a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admin/preorder/remark/change_1" method="post">
...
$('a').click(function(){
    ...
    var d = typeof(data);
                    ...
                    $("#frm_pre").attr('action',"/admin/preorder/change_2");
