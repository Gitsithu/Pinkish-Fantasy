                                    ...
                                    <tbody>
                                       ...
                                       @foreach ($preorders as $preorder)
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="/admin/preorder/detail_d/{{ $parameter }}" style="font-weight:bold;padding-top:10px;height:40px;background-color:#f5a8ae!important;border:#f5a8ae!important;" class="form-control btn btn-warning"  id="btn_new">View Detail</a>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/admin/preorder/remark/change_4" method="post">
...
var d = typeof(data);
            ...
            $("#frm_pre").attr('action',"/admin/preorder/change_4");
