                        ...
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                   <form action="/admin/promotion/update/{{ isset($promotions)? $promotions->id:0 }}" method="post"  enctype="multipart/form-data" id="general-info" class="section general-info">
                    <!-- <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> -->
                                    {{csrf_field()}}
                                    {{ method_field('PATCH') }}
                                            <div class="info">
                                            <h6 class="">Editng Promotion</h6>
                                                            ...
                                                            <div class="form">
                                                                ...
                                                                <div class="col-sm-4">
                                                                        <div class="form-group">
                                                                            <label for="degree3">Event Name</label>
                                                                               <input type="text" class="form-control" value="{{ isset($promotions)? $promotions->name:Request::old('name') }}" name="name" placeholder="Type Event Name" >
