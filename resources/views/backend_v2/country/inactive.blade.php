        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="row">
                 ...
                 <div class="col-md-8">
                 <a href="/admin/country/create" style="font-weight:bold;background-color:#f5a8ae!important;border:#f5a8ae!important;padding-top:10px;height:40px;" class="form-control btn btn-primary"  id="btn_new">Create New Option</a>
                 </div>

                 <div class="col-md-2">
                 <a href="/admin/country/" class="form-control btn btn-success"  id="btn_new" style="height:40px;padding-top:10px;">View Active</a>
                 </div>
                 <div class="col-md-2">
                <form method="post" action="/admin/country/activate">
                                ...
                                <table class="multi-table table table-hover">
                                    ...
                                    <tbody>
                                       @foreach ($countries as $country)
                                        ...
                                        <td>
                                            <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                                <input type="checkbox" class="new-control-input todochkbox"  name="id[]" value="{{$country->id}}" id="todo-1">
                                                <span class="new-control-indicator"></span>

                                        </td>
                                            <td><b>{{ $country->name}}</b></td>
                                             <td><b>{{ $country->exchange_rate}}</b></td>
...
<script>
    ...
    var d = typeof(data);
                    ...
                    $("#frm_pre").attr('action',"/admin/country/activate");
