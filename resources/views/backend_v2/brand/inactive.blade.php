        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="row">
                 ...
                 <div class="col-md-2">
                 <a href="/admin/brand/" style="padding-top:10px;height:40px;" class="form-control btn btn-success"  id="btn_new">View Active</a>
                 </div>
                <div class="col-md-2">
                <form method="post" action="/admin/brand/activate">
                                ...
                                <table class="multi-table table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: black;" class="text-center">Brand Name</th>
                                    ...
                                    <tbody>
                                       ...
                                       @foreach ($brands as $brand)
                                        ...
                                        <td>
                                        <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                        <input type="checkbox" class="new-control-input todochkbox"  name="id[]" value="{{$brand->id}}" id="todo-1">
                                        <span class="new-control-indicator"></span>

                                      </td>

                                            <td class="text-center"><b>{{ $brand->name}}</b></td>
...
<script>
    ...
    var d = typeof(data);
                    ...
                    $("#frm_pre").attr('action',"/admin/brand/activate");
