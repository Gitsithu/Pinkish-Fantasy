                 ...
                 @endif
                       @if (count($errors) > 0)
                        ...
                        <div class="col-md-2 offset-md-10">
                            <a href="/admin/ui/inactive" style="padding-top:10px;height:40px;" class="form-control btn btn-danger" id="btn_new">View Inactive</a>
                        </div>
            </div>
                                    ...
                                    <tbody>
                                       @foreach ($ui_imgs as $ui_img)
                                        <tr>
                                            ...
                                            ?>
                                            <td class="text-center"><a onclick="return myFunction();" href="/admin/ui/edit/{{ $parameter }}" class="btn btn-info" style="background-color:#f5a8ae!important;border:#f5a8ae!important;">Edit</a></td>
