                        ...
                        <!-- this is end for alert the message box when user take action -->
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <form action="/admin/item_specification/store_preorder" method="post" enctype="multipart/form-data" id="general-info" class="section general-info">
                                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="text-center">
                                                                        <input type="text" name="size[]" class="form-control dx" id="size" required>
                                            ...
                                            @include('backend_v2.modals.script_preorder')
                                        </div>
                                    </form>
                                </div>
                            </div>
