            ...
            <div class="layout-px-spacing">
                ...
                <div class="row">
                 ...
                 @endif
                    ...
                    <div class="col-md-2">
                    <a href="/admin/category/inactive" style="padding-top:10px;height:40px;" class="form-control btn btn-danger" id="btn_new">View Inactive</a>
                    </div>
                                    ...
                                    <tbody>
                                       @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td class="text-center"><a onclick="return myFunction();" href="/admin/category/edit/{{ $parameter }}" class="btn btn-info" style="background-color:#f5a8ae!important;border:#f5a8ae!important;">Edit</a>
                                            </td>
