...
<div class="modal fade" id="Modal_image_upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="modal fade" id="modal-image2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 380px; height: 220px;">
                                <img id='image_urlPopUp2' src="{{ isset($obj)? $obj->image_url2:Request::old('image_url2') }}" alt="Load Image"/>
                            </div>
                        ...
                        <span class="btn btn-default btn-file">
                            ...
                            <input id="image_url2" type="file" name="image_url2" accept="image.*" />
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="changeItemImage2()" class="btn btn-default" data-dismiss="modal">Save</button>
                </div>
    ...
    <div class="modal fade" id="modal-image2-remove" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="removeIMG2()" class="btn btn-default" data-dismiss="modal">Yes</button>
                </div>
...
<script type="text/javascript">
    ...
    $(".add_image_div2").click(function(){
        showPopup2();
    });

    $("#removeImage2").click(function(){
        $('#modal-image2-remove').modal();
    });
    ...
    function changeItemImage2(){
        var images = $('#modal-image2 img').attr('src');
        $('.add_image_div2').css('background-image', 'url(' + images + ')');
        $('#removeImageFlag2').val(0);
    }

    function removeIMG2(){
        $('#modal-image2 img').attr('src','second.jpg');
        $('.add_image_div2').css('background-image', 'url()');
        $('#removeImageFlag2').val(1);
    }   
</script>