...
<div class="modal fade" id="Modal_image_upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="modal fade" id="modal-image6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 380px; height: 220px;">
                                <img id='image_urlPopUp6' src="{{ isset($obj)? $obj->image_url6:Request::old('image_url6') }}" alt="Load Image"/>
                            </div>
                        ...
                        <span class="btn btn-default btn-file">
                            ...
                            <input id="image_url6" type="file" name="image_url6" accept="image.*" />
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="changeItemImage6()" class="btn btn-default" data-dismiss="modal">Save</button>
                </div>
    ...
    <div class="modal fade" id="modal-image6-remove" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="removeIMG6()" class="btn btn-default" data-dismiss="modal">Yes</button>
                </div>
...
<script type="text/javascript">
    ...
    $(".add_image_div6").click(function(){
        showPopup6();
    });

    $("#removeImage6").click(function(){
        $('#modal-image6-remove').modal();
    });
    ...
    function changeItemImage6(){
        var images = $('#modal-image6 img').attr('src');
        $('.add_image_div6').css('background-image', 'url(' + images + ')');
        $('#removeImageFlag6').val(0);
    }

    function removeIMG6(){
        $('#modal-image6 img').attr('src','second.jpg');
        $('.add_image_div6').css('background-image', 'url()');
        $('#removeImageFlag6').val(1);
    }   
</script>