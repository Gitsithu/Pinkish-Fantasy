                    ...
                    <div class="col-md-12 text-center">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 380px; height: 220px;">
                                <img id='image_urlPopUp' src="{{ isset($orders)? $orders->payment_screenshot:Request::old('payment_screenshot') }}" alt="Load Image"/>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="col-md-12 text-center">
                        <div class="form-group">
                            <label class="font-big-red" style="color:red;font-size:25px;">You can only upload a .jpg / jpeg / png / gif file format.</label>
                        </div>
                    </div>
                </div>
