...
<div class="modal fade" id="Modal_image_upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="modal fade" id="modal-image10" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 390px; height: 220px;">
                                <img id='image_urlPopUp10' src="{{ isset($obj)? $obj->image_url10:Request::old('image_url10') }}" alt="Load Image"/>
                            </div>
                        ...
                        <span class="btn btn-default btn-file">
                            ...
                            <input id="image_url10" type="file" name="image_url10" accept="image.*" />
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="changeItemImage10()" class="btn btn-default" data-dismiss="modal">Save</button>
                </div>
    ...
    <div class="modal fade" id="modal-image10-remove" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="removeIMG10()" class="btn btn-default" data-dismiss="modal">Yes</button>
                </div>
...
<script type="text/javascript">
    ...
    $(".add_image_div10").click(function(){
        showPopup10();
    });

    $("#removeImage10").click(function(){
        $('#modal-image10-remove').modal();
    });
    ...
    function changeItemImage10(){
        var images = $('#modal-image10 img').attr('src');
        $('.add_image_div10').css('background-image', 'url(' + images + ')');
        $('#removeImageFlag10').val(0);
    }

    function removeIMG10(){
        $('#modal-image10 img').attr('src','second.jpg');
        $('.add_image_div10').css('background-image', 'url()');
        $('#removeImageFlag10').val(1);
    }
</script>
