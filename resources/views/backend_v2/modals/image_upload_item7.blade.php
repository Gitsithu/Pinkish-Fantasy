...
<div class="modal fade" id="Modal_image_upload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="modal fade" id="modal-image7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="col-md-12 text-center">
                        <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 380px; height: 220px;">
                                <img id='image_urlPopUp7' src="{{ isset($obj)? $obj->image_url7:Request::old('image_url7') }}" alt="Load Image"/>
                            </div>
                        ...
                        <span class="btn btn-default btn-file">
                            ...
                            <input id="image_url7" type="file" name="image_url7" accept="image.*" />
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="changeItemImage7()" class="btn btn-default" data-dismiss="modal">Save</button>
                </div>
    ...
    <div class="modal fade" id="modal-image7-remove" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="removeIMG7()" class="btn btn-default" data-dismiss="modal">Yes</button>
                </div>
...
<script type="text/javascript">
    ...
    $(".add_image_div7").click(function(){
        showPopup7();
    });

    $("#removeImage7").click(function(){
        $('#modal-image7-remove').modal();
    });
    ...
    function changeItemImage7(){
        var images = $('#modal-image7 img').attr('src');
        $('.add_image_div7').css('background-image', 'url(' + images + ')');
        $('#removeImageFlag7').val(0);
    }

    function removeIMG7(){
        $('#modal-image7 img').attr('src','second.jpg');
        $('.add_image_div7').css('background-image', 'url()');
        $('#removeImageFlag7').val(1);
    }   
</script>