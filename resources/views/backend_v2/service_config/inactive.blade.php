            ...
            <div class="layout-px-spacing">
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-8">
                        <div class="row">
                            <div class="col-md-4">
                                <a href="/admin/service/" style="padding-top:10px;height:40px;" class="form-control btn btn-success"  id="btn_new">View Active</a>
                                </div>
                            <div class="col-md-4">
                            <form method="post" action="/admin/service/activate">
                                    ...
                                    <tbody>
                                       ...
                                       @foreach ($service_config as $service)
                                        ...
                                        <tr>
                                            <td>
                                                <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                                <input type="checkbox" class="new-control-input todochkbox"  name="id[]" value="{{$service->id}}" id="todo-1">
                                                <span class="new-control-indicator"></span>
                                            </td>
...
<script>
    function change(){
        ...
        $("#frm_pre").attr('action',"/admin/service/activate");
