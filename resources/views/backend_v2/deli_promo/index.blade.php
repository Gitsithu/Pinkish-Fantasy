        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                <div class="row">
                 ...
                 <div class="col-md-12">
                 <a href="/admin/deli_promo/create" style="font-weight:bold;background-color:#f5a8ae!important;border:#f5a8ae!important;padding-top:10px;height:40px;" class="form-control btn btn-primary"  id="btn_new">Create New Promotion</a>
                 </div>
                                ...
                                <table class="multi-table table table-hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: black;" class="text-center">End Date</th>
                                    ...
                                    <tbody>
                                       @foreach ($promotions as $promotion)
                                        <tr>
                                            ...
                                            <td class="text-center">{{$promotion->amt}}</td>
                                            <td>
                                            ...
                                            <td class="text-center"><a onclick="return myFunction();" href="/admin/deli_promo/edit/{{ $parameter }}" class="btn btn-info" style="background-color:#f5a8ae!important;border:#f5a8ae!important;">Edit</a>
                                            </td>
