            ...
            <div class="layout-px-spacing">
                ...
                <div class="row">
                 ...
                 @endif
                    ...
                    <div class="col-md-2">
                    <a href="/admin/main_category/" class="form-control btn btn-success"  id="btn_new" style="height:40px;padding-top:10px;">View Active</a>
                    </div>
                    <div class="col-md-2">
                <form method="post" action="/admin/main_category/activate">
                                    ...
                                    <tbody>
                                       @foreach ($main_categories as $main_category)
                                        ...
                                        <td>
                                            ...
                                            <label class="new-control new-checkbox checkbox-primary" style="height: 18px; margin: 0 auto;">
                                                <input type="checkbox" class="new-control-input todochkbox"  name="id[]" value="{{$main_category->id}}" id="todo-1">
                                                <span class="new-control-indicator"></span>
                                            ...
                                            @else
                                           <div class="t-dot bg-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="In-active"></div></td>
                                            @endif
                                            </td>
                                            <td class="text-center">
...
<script>
    ...
    var d = typeof(data);
                    ...
                    $("#frm_pre").attr('action',"/admin/main_category/activate");
