                ...
                <div class="row">
                 ...
                 @endif
                       @if (count($errors) > 0)
                         ...
                         <div class="col-md-6">
                            <a href="/admin/order/deliver" style="font-weight:bold;padding-top:10px;height:40px;" class="form-control btn btn-success"  id="btn_new">Delivered</a>
                            </div>
                        </div>
                                         ...
                                         <tr>
                                            ...
                                            @endif
                                             ...
                                             <td class="text-center">
                                                    ...
                                                    <a href="/admin/order/detail_c/{{$parameter}}"><button type="submit" onclick="return myFunction1();" class="btn btn-danger" style="font-weight:bold;background-color:#f5a8ae!important;border:#f5a8ae!important;" >View_Detail</button></a>
