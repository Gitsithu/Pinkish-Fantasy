                                         ...
                                         <tr>
                                            ...
                                            @endif
                                             ...
                                             <td class="text-center">
                                                    ...
                                                    <a href="/admin/order/detail/{{$parameter}}"><button type="submit" onclick="return myFunction1();" class="btn btn-danger" style="font-weight:bold;background-color:#f5a8ae!important;border:#f5a8ae!important;" >View_Detail</button></a>
